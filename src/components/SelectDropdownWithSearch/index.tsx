...
const SelectDropdownWithSeearch = (
  {
    ...
    defaultValueByIndex: number /* integer */;
    disabled: boolean /* boolean */;
    disableAutoScroll: boolean /* boolean */;
    onFocus: any /* function  */;
    onBlur: any /* function  */;
    ...
    dropdownStyle: any;
    dropdownOverlayColor: string /* string */;
    /////////////////////////////
    rowStyle: any /* style object for row */;
    rowTextStyle: any /* style object for row text */;
    renderCustomizedRowChild: any /* function returns React component for customized row */;
    emptyListMessage: string /* message to display for empty list */;
    isItemSelected: any;
  },
  ref: any,
) => {
  const { Layout, Fonts, Colors, Gutters } = useTheme();
  const styles = getStyles(Colors, Layout, Gutters, Fonts);
  ///////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////
  /* ******************** Render Methods ******************** */
  const renderFlatlistItem = ({ item, index }: { item: any; index: any }) => {
    return (
      <TouchableOpacity
        activeOpacity={0.8}
        style={[
          { ...styles.dropdownRow, ...rowStyle },
          selectedItem !== null && isItemSelected(item, selectedItem)
  ...
  const renderDropdown = () => {
    let inputColor = Colors.primaryTextColor;
          ...
          >
            ...
            >
              <TextInput
                ...
                // isFocus={(focused: any) => setIsDisplayingOptions(focused)}
                onChangeText={value => {
                  // setSearch(value);
                  // // onSearch(value);
                  // if (value.length === 0) {
            ...
            <View style={[Layout.column]}>
              ...
              {(!items || items.length == 0) && !searchLoading && (
                <View style={[{ ...styles.dropdownRow, ...rowStyle }]}>
                  {/* <ActivityIndicator
                  size="small"
    ...
    >
      ...
      {renderCustomizedButtonChild ? (
        ...
        <Text
          numberOfLines={1}
          allowFontScaling={false}
          style={{ ...buttonTextStyle, ...styles.dropdownButtonText }}
        >
...
export default forwardRef((props: any, ref) =>
  SelectDropdownWithSeearch(props, ref),
);
